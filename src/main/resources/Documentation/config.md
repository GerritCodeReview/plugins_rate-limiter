...
Notification user groups are defined by setting 'sendemailrecipients' in 'sendemail' section.
'sendemailrecipients' setting specifies access groups, which members will receive notification
emails.
...
```
  ...
  [sendemail]
    sendemailrecipients = Access_Group_1, Access_Group_2, Registered Users
```
