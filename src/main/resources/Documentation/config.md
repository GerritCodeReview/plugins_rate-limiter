...
type. Notification user groups are defined per limit type setting 'uploadpackperhourwarn' or
'uploadpackperhour' in 'sendemail' section.
...
```
  ...
  [sendemail]
    uploadpackperhourwarn = Access_Group_1, Access_Group_2
