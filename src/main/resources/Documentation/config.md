...
property specifies user groups, which members will receive notification emails.
...
limits will be sent to members of `Access_Group_1, Access_Group_2, Access_Group_3` access
groups.
