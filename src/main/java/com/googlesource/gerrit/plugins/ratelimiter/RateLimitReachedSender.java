...
public class RateLimitReachedSender extends OutgoingEmail {
  ...
  protected boolean shouldSendMessage() {
    ...
    List<UUID> warmLimitRecipients = configuration.getRecipients(RateLimitSeverity.SOFT_LIMIT);
    if (!acquirePermit) {
      warmLimitRecipients = configuration.getRecipients(RateLimitSeverity.HARD_LIMIT);
    }
    return groupMembership.containsAnyOf(warmLimitRecipients);
  }
